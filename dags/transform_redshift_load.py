...
transform_task = GlueJobOperator(
    ...
    script_location='s3://aws-glue-assets-851725352255-us-east-1/scripts/weather_data_ingestion.py',
    s3_bucket='s3://aws-glue-assets-851725352255-us-east-1',  # S3 bucket where logs and local etl script will be uploaded
